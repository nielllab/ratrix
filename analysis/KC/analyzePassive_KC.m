...
alluse = find(strcmp({files.virus},'caspase3') & strcmp({files.genotype},'calb2cre-ck2-gc6')...
    & strcmp({files.inject},'none') & strcmp({files.monitor},'land')...
    & strcmp({files.timing},'post') & strcmp({files.notes},'good data')...
