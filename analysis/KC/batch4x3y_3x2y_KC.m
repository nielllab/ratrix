...
% files(n).notes = 'good data';
% 
%% G6H1137TT @ 1.0 mg/kg --> where are these files? wrong date?
% n=n+1;
% files(n).subj = 'G6H137TT'; %animal name
% files(n).expt = '061719'; %date of experiment
% files(n).topox= '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_PRE_TOPOX\061719_G6H137TT_RIG2_PRE_TOPOXmaps.mat'; %where to put dfof
% files(n).topoxdata = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_PRE_TOPOX\061719_G6H137TT_RIG2_PRE_TOPOX'; %raw data
% files(n).topoy = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_PRE_TOPOY\061719_G6H137TT_RIG2_PRE_TOPOYmaps.mat';
% files(n).topoydata = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_PRE_TOPOY\061719_G6H137TT_RIG2_PRE_TOPOY';
% files(n).grating3x2y6sf4tf =  '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_PRE_THREEXTWOY\061719_G6H137TT_RIG2_PRE_THREEXTWOYmaps.mat';
% files(n).grating3x2y6sf4tfdata = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_PRE_THREEXTWOY\061719_G6H137TT_RIG2_PRE_THREEXTWOY';
% files(n).inject = 'CLOZ'; 
% files(n).dose = '1.0 mg_kg'
% files(n).controlvirus = 'no';
% files(n).timing = 'pre';
...
% files(n).subj = 'G6H137TT'; %animal name
% files(n).expt = '061719'; %date of experiment
% files(n).topox= '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_POST_TOPOX\061719_G6H137TT_RIG2_POST_TOPOXmaps.mat'; %where to put dfof
% files(n).topoxdata = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_POST_TOPOX\061719_G6H137TT_RIG2_POST_TOPOX'; %raw data
% files(n).topoy = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_POST_TOPOY\061719_G6H137TT_RIG2_POST_TOPOYmaps.mat';
% files(n).topoydata = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_POST_TOPOY\061719_G6H137TT_RIG2_POST_TOPOY';
% files(n).grating3x2y6sf4tf =  '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_POST_THREEXTWOY\061719_G6H137TT_RIG2_POST_THREEXTWOYmaps.mat';
% files(n).grating3x2y6sf4tfdata = '061719_G6H137TT_RIG2\061719_G6H137TT_RIG2_POST_THREEXTWOY\061719_G6H137TT_RIG2_POST_THREEXTWOY';
% files(n).inject = 'CLOZ'; 
% files(n).dose = '1.0 mg_kg'
% files(n).controlvirus = 'no'
% files(n).timing = 'post';
...
% files(n).subj = 'G6H1210LT'; %animal name
% files(n).expt = '061719'; %date of experiment
% files(n).topox= '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_PRE_TOPOX\061719_G6H1210LT_RIG2_PRE_TOPOXmaps.mat'; %where to put dfof
% files(n).topoxdata = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_PRE_TOPOX\061719_G6H1210LT_RIG2_PRE_TOPOX'; %raw data
% files(n).topoy = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_PRE_TOPOY\061719_G6H1210LT_RIG2_PRE_TOPOYmaps.mat';
% files(n).topoydata = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_PRE_TOPOY\061719_G6H1210LT_RIG2_PRE_TOPOY';
% files(n).grating3x2y6sf4tf =  '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_PRE_THREEXTWOY\061719_G6H1210LT_RIG2_PRE_THREEXTWOYmaps.mat';
% files(n).grating3x2y6sf4tfdata = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_PRE_THREEXTWOY\061719_G6H1210LT_RIG2_PRE_THREEXTWOY';
% files(n).inject = 'CLOZ'; 
% files(n).dose = '1.0 mg_kg'
% files(n).controlvirus = 'no';
% files(n).timing = 'pre';
...
% files(n).subj = 'G6H1210LT'; %animal name
% files(n).expt = '061719'; %date of experiment
% files(n).topox= '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_POST_TOPOX\061719_G6H1210LT_RIG2_POST_TOPOXmaps.mat'; %where to put dfof
% files(n).topoxdata = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_POST_TOPOX\061719_G6H1210LT_RIG2_POST_TOPOX'; %raw data
% files(n).topoy = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_POST_TOPOY\061719_G6H1210LT_RIG2_POST_TOPOYmaps.mat';
% files(n).topoydata = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_POST_TOPOY\061719_G6H1210LT_RIG2_POST_TOPOY';
% files(n).grating3x2y6sf4tf =  '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_POST_THREEXTWOY\061719_G6H1210LT_RIG2_POST_THREEXTWOYmaps.mat';
% files(n).grating3x2y6sf4tfdata = '061719_G6H1210LT_RIG2\061719_G6H1210LT_RIG2_POST_THREEXTWOY\061719_G6H1210LT_RIG2_POST_THREEXTWOY';
% files(n).inject = 'CLOZ'; 
