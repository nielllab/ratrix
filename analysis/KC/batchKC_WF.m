...
% files(n).occlusion =  '111218_G6H121TT_RIG2\111218_G6H121TT_RIG2_PRE_PATCHONPATCH\111218_G6H121TT_RIG2_PRE_PATCHONPATCHmaps.mat';
% files(n).occlusiondata = '111218_G6H121TT_RIG2\111218_G6H121TT_RIG2_PRE_PATCHONPATCH\111218_G6H121TT_RIG2_PRE_PATCHONPATCH';
% files(n).inject = 'CLOZ'; 
% files(n).timing = 'pre';
% files(n).training = 'naive';
% files(n).area = 'lp';
...
% files(n).occlusion =  '111218_G6H121TT_RIG2\111218_G6H121TT_RIG2_POST_PATCHONPATCH\111218_G6H121TT_RIG2_POST_PATCHONPATCHmaps.mat';
% files(n).occlusiondata = '111218_G6H121TT_RIG2\111218_G6H121TT_RIG2_POST_PATCHONPATCH\111218_G6H121TT_RIG2_POST_PATCHONPATCH';
% files(n).inject = 'CLOZ'; 
% files(n).timing = 'post';
% files(n).training = 'naive';
% files(n).area = 'lp';
