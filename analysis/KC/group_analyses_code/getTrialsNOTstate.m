function [idxTrials] = getTrialsNOTstate(conAndDurOrderedByTrialMeetCriteria,c,d,uniqueContrasts,uniqueDurations,behStateTrials) % large vs small pupil trial indicies
