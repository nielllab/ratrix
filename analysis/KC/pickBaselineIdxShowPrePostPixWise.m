function [stimOnsetFrame,baselineIdx] = pickBaselineIdxShowPrePostPixWise(numPreStimFrames,conOrderedByTrialMeetCriteria,uniqueContrasts,date,subjName,onsetDf) 
