...
for group=1:2
    ...
    if group==1
        use = strcmp({files.training},'naive') & strcmp({files.label},'camk2 gc6') & (strcmp({files.notes},'good darkness and stimulus') | strcmp({files.notes},'good stimulus'))  ) 
        grpfilename = 'SalineNaiveIsoCrossWF'
    elseif group==2
        use = strcmp({files.training},'trained') & strcmp({files.label},'camk2 gc6') & (strcmp({files.notes},'good darkness and stimulus') | strcmp({files.notes},'good stimulus'))  ) 
