...
for rep = 1:2   % rep 1 = ON, rep 2 = OFF
    ...
    toc
    sgtitle(sprintf('Block STA Map (%s)', repLabel), 'Interpreter', 'none');
    if exist('psfile','var'); exportgraphics(gcf, psfile, 'Append', true); end
    ...
    toc
    sgtitle(sprintf('Block Timecourse Map (%s)', repLabel), 'Interpreter', 'none');
    if exist('psfile','var'); exportgraphics(gcf, psfile, 'Append', true); end
    drawnow
...
figure
subplot(2,1,1)
plot(zscore(:,1), rfx(:,1), '.'); title('on'); xlabel('zscore'); ylabel('rf X');
...
title('Correlation Across Cells After Clustering', 'Interpreter', 'none')
if exist('psfile','var'); exportgraphics(gcf, psfile, 'Append', true); end
