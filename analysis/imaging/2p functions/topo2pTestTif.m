...
framerate = 10 %imaging rate
spatialBin = 4; %spatial downsample factor (map will look cleaner)

fileName = uigetfile('*.tif','topo file');

first_frame = 1; %feed this in as an argument? how does evan get this?
...
tic
for ii = first_frame+1:size(tiff_info, 1)
...
dt = 1/framerate; %%% resampled time frame
