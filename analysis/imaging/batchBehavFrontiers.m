...
dbstop if error
pathname = '\\langevin\backup\widefield\compiled behavior\';
...
files(n).topoy = '';
files(n).topoydata = '100914 g62c6ttgts passive viewing\g62c6ttgts_run3_topoX_50ms_Fstop8_100sf\g62c6ttgts_run3_topoX_50ms_Fstop8_100sf';
files(n).behav = '';
...
files(n).spatialfreq = '200';
files(n).label = 'camk2 gc6';
files(n).notes = 'good imaging session - poor performance'; %poor behavior run 60's for percent
...
files(n).spatialfreq = '100';
files(n).label = 'camk2 gc6';
files(n).notes = 'good imaging session major artifact'; % light block hat tiped towards end of session (after ~frame1300)
...
files(n).spatialfreq = '100';
files(n).label = 'camk2 gc6';
files(n).notes = 'good imaging session - major artifact';
