...
datapathname = 'G:\Behavior data 12-24-13+\';  %files(n).spatialfreq = '';
...
files(n).label = 'camk2 gc6';
files(n).notes = 'good imaging session, 400 spatial frequency';   %Lightblock cone tipped during passive viewing
