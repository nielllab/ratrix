...
% % files(n).task = 'HvV';
% % files(n).label = 'camk2 gc6';
% % files(n).notes = 'decent imaging session';
...
files(n).task = 'HvV';
files(n).label = 'camk2 gc6';
files(n).notes = 'good imaging session, 400 spatial frequency';
...
files(n).task = 'GTS';
files(n).label = 'camk2 gc6';
files(n).notes = 'good imaging session, 200 spatial frequency';
...
files(n).auditory = '052514 g62b.1lt passive vieiwng\g62b1lt_run4_audio_fstop11_exp50ms_maps.mat';
...
files(n).darkness = '052514 g62b.1lt passive vieiwng\g62b1lt_run3_darkness_fstop11_exp50ms_maps.mat';
...
files(n).task = 'HvV';
files(n).label = 'camk2 gc6';
files(n).notes = 'good imaging session, 200 spatial frequency, darkness and audio passive available';
