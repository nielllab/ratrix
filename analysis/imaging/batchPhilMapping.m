...
% files(n).expt = '082916';
% files(n).topox= '082916_G62BB7LT_MAP_RIG2\082916_G62BB7LT_MAP_RIG2_TOPOX\082916_G62BB7LT_MAP_RIG2_TOPOXmaps.mat';
% files(n).topoxdata = '082916_G62BB7LT_MAP_RIG2\082916_G62BB7LT_MAP_RIG2_TOPOX\082916_G62BB7LT_MAP_RIG2_TOPOX';
% files(n).topoy = '082916_G62BB7LT_MAP_RIG2\082916_G62BB7LT_MAP_RIG2_TOPOY\082916_G62BB7LT_MAP_RIG2_TOPOYmaps.mat';
% files(n).topoydata = '082916_G62BB7LT_MAP_RIG2\082916_G62BB7LT_MAP_RIG2_TOPOY\082916_G62BB7LT_MAP_RIG2_TOPOY';
% files(n).inject = 'none';
% files(n).rignum = 'rig2';
% files(n).monitor = 'portrait';
% files(n).label = 'camk2 gc6';
...
% 
% n=n+1;
% files(n).subj = 'G62CC6LT';
% files(n).expt = '082916';
% files(n).topox= '082916_G62CC6LT_MAP_RIG2\082916_G62CC6LT_MAP_RIG2_TOPOX\082916_G62CC6LT_MAP_RIG2_TOPOXmaps.mat';
% files(n).topoxdata = '082916_G62CC6LT_MAP_RIG2\082916_G62CC6LT_MAP_RIG2_TOPOX\082916_G62CC6LT_MAP_RIG2_TOPOX';
% files(n).topoy = '082916_G62CC6LT_MAP_RIG2\082916_G62CC6LT_MAP_RIG2_TOPOY\082916_G62CC6LT_MAP_RIG2_TOPOYmaps.mat';
% files(n).topoydata = '082916_G62CC6LT_MAP_RIG2\082916_G62CC6LT_MAP_RIG2_TOPOY\082916_G62CC6LT_MAP_RIG2_TOPOY';
% files(n).inject = 'none';
% files(n).rignum = 'rig2';
% files(n).monitor = 'portrait';
% files(n).label = 'camk2 gc6';
...
% files(n).expt = '082916';
% files(n).topox= '082916_G62FF2RT_MAP_RIG2\082916_G62FF2RT_MAP_RIG2_TOPOX\082916_G62FF2RT_MAP_RIG2_TOPOXmaps.mat';
% files(n).topoxdata = '082916_G62FF2RT_MAP_RIG2\082916_G62FF2RT_MAP_RIG2_TOPOX\082916_G62FF2RT_MAP_RIG2_TOPOX';
% files(n).topoy = '082916_G62FF2RT_MAP_RIG2\082916_G62FF2RT_MAP_RIG2_TOPOY\082916_G62FF2RT_MAP_RIG2_TOPOYmaps.mat';
% files(n).topoydata = '082916_G62FF2RT_MAP_RIG2\082916_G62FF2RT_MAP_RIG2_TOPOY\082916_G62FF2RT_MAP_RIG2_TOPOY';
% files(n).inject = 'none';
% files(n).rignum = 'rig2';
% files(n).monitor = 'portrait';
% files(n).label = 'camk2 gc6';
...
% files(n).expt = '082916';
% files(n).topox= '082916_G62MM3RN_MAP_RIG2\082916_G62MM3RN_MAP_RIG2_TOPOX\082916_G62MM3RN_MAP_RIG2_TOPOXmaps.mat';
% files(n).topoxdata = '082916_G62MM3RN_MAP_RIG2\082916_G62MM3RN_MAP_RIG2_TOPOX\082916_G62MM3RN_MAP_RIG2_TOPOX';
% files(n).topoy = '082916_G62MM3RN_MAP_RIG2\082916_G62MM3RN_MAP_RIG2_TOPOY\082916_G62MM3RN_MAP_RIG2_TOPOYmaps.mat';
% files(n).topoydata = '082916_G62MM3RN_MAP_RIG2\082916_G62MM3RN_MAP_RIG2_TOPOY\082916_G62MM3RN_MAP_RIG2_TOPOY';
% files(n).inject = 'none';
% files(n).rignum = 'rig2';
% files(n).monitor = 'portrait';
% files(n).label = 'camk2 gc6';
...
% files(n).expt = '082916';
% files(n).topox= '082916_G62Z5RTT_MAP_RIG2\082916_G62Z5RTT_MAP_RIG2_TOPOX\082916_G62Z5RTT_MAP_RIG2_TOPOXmaps.mat';
% files(n).topoxdata = '082916_G62Z5RTT_MAP_RIG2\082916_G62Z5RTT_MAP_RIG2_TOPOX\082916_G62Z5RTT_MAP_RIG2_TOPOX';
% files(n).topoy = '082916_G62Z5RTT_MAP_RIG2\082916_G62Z5RTT_MAP_RIG2_TOPOY\082916_G62Z5RTT_MAP_RIG2_TOPOYmaps.mat';
% files(n).topoydata = '082916_G62Z5RTT_MAP_RIG2\082916_G62Z5RTT_MAP_RIG2_TOPOY\082916_G62Z5RTT_MAP_RIG2_TOPOY';
% files(n).inject = 'none';
% files(n).rignum = 'rig2';
% files(n).monitor = 'portrait';
% files(n).label = 'camk2 gc6';
...
files(n).expt = '092016';
files(n).topox =  '092016_G62BB2RT_DOI_RIG2\092016_G62BB2RT_DOI_RIG2_PRE_TOPOX\092016_G62BB2RT_DOI_RIG2_PRE_TOPOXmaps.mat';
files(n).topoxdata = '092016_G62BB2RT_DOI_RIG2\092016_G62BB2RT_DOI_RIG2_PRE_TOPOX\092016_G62BB2RT_DOI_RIG2_PRE_TOPOX';
files(n).topoy =  '092016_G62BB2RT_DOI_RIG2\092016_G62BB2RT_DOI_RIG2_PRE_TOPOY\092016_G62BB2RT_DOI_RIG2_PRE_TOPOYmaps.mat';
files(n).topoydata = '092016_G62BB2RT_DOI_RIG2\092016_G62BB2RT_DOI_RIG2_PRE_TOPOY\092016_G62BB2RT_DOI_RIG2_PRE_TOPOY';
files(n).inject = 'none';
files(n).rignum = 'rig2'; %%% or 'rig1'
files(n).monitor = 'portrait'; %%% for topox and y
files(n).label = 'camk2 gc6'; %%% or 'calb2'
