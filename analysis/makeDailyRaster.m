function [trialsPerDay correctPerDay dates]=makeDailyRaster(correct,response,date,which,smoothingWidthForPerformance,minsPerBin,subject,usingPerformance,handles,subplotParams,plotResponseDensity,plotResponseRaster,savePath)
...
if numTrials>0
    ...
    if plotResponseRaster        
        ...
        pctTime=pctTime(mask);
        dayIndex=dayIndex(mask);
