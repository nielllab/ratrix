...
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[30]};%SF
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[25]};%ffflank

subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[5 14]};%error in analysis
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[15 21]};%error in analysis
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[38 44]};%sparse bright
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[46 50]};%ffgwn

subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[66]};%trf DUPPED
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[93 110   ]};%6x8 bin DUPPED
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[70 91]};%3x4 bin DUPPED

subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[70 73]};%ffFlanker
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[75]};%ffFlanker contrast - gamma
% subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[79 83]};%ffFlanker contrast - lin
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[81 87]};%ffFlanker contrast - lin
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[90]};%ffFlanker contrast - closer to screen (15)
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[91]};%ffFlanker contrast - closer to screen (15)
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[93 94]};%ffFlanker contrast - 128 ppc - has an error?
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[96]};%confirm cell in there with hammer
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[99]};%luminance ff flankers drive it. (step 7)
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[103 105]};%fff contr drive it weakly. (step 40)
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[106 109]};%fff contr drive it weakly. (step 40)
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[106 124]};%fff contr drive it weakly. (step 40)
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[125]};%

%NEW CELL
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[127 129]};%nat grating

subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[134]};%trf
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[140]};%sparse dark
%manual stuff
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[149]};%seems quite suppressed by some gratings
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[149]};%seems quite suppressed by some gratings
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[152 154]};%ffgwn
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[158]};%trf! - may be good but skipped
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[162 163 ]};%bin grid-
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[167]};%fff
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[168]};%fff
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[169 172]};%fff

%NEW CELL
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[269]};%trf
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[271 272]};%fffc

%NEW CELL
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[292]};%trf
%trying to tune it in
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[295]};%trf

%NEW CELL
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[356]};%trf

subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[361 368]};%fffc
subjectID = '231'; spikeChannels={1}; cellBoundary={'trialRange',[370]};%sf

subjectID = 'test1'; spikeChannels={1}; cellBoundary={'trialRange',[405]};%trf
subjectID = 'test1'; spikeChannels={1}; cellBoundary={'trialRange',[415]};%trf
subjectID = 'test1'; spikeChannels={1}; cellBoundary={'trialRange',[419]};%trf
subjectID = 'test1'; spikeChannels={1}; cellBoundary={'trialRange',[427]};%trf

%% START WITH 342

subjectID = '342'; spikeChannels={6}; cellBoundary={'trialRange',[9]};%trf - fake data test 17sec chunks
subjectID = '342'; spikeChannels={1}; cellBoundary={'trialRange',[14]};%trf - first real data, but chunk errors
subjectID = '342'; spikeChannels={1}; cellBoundary={'trialRange',[48 52]};%the only reasonable trials so far
subjectID = '342'; spikeChannels={1}; cellBoundary={'trialRange',[57]};%big slow ref'd to ground
%subjectID = '342'; spikeChannels={1}; cellBoundary={'trialRange',[58]};%big slow messing with ref
%subjectID = '342'; spikeChannels={1}; cellBoundary={'trialRange',[60]};%no messing with ref - using Agnd

%% 

subjectID = '342'; spikeChannels={[1]}; cellBoundary={'trialRange',[64]};%gwn
subjectID = '342'; spikeChannels={[1]}; cellBoundary={'trialRange',[68 80]};%12 x 16 bin
subjectID = '342'; spikeChannels={[1 2 3 4]}; cellBoundary={'trialRange',[86]};%gwn
subjectID = '342'; spikeChannels={[1]}; cellBoundary={'trialRange',[90 95]};%bin not much there
subjectID = '342'; spikeChannels={[1 2 3 4]}; cellBoundary={'trialRange',[96]};%bin not much there
%% current
subjectID = '342'; spikeChannels={[1]}; cellBoundary={'trialRange',[64]};%gwn
...
%spikeDetectionParams.LFPBandPass = [1 20];
paramUtil=[]; 
%paramUtil.HiLo=[10 10000];
...
analysisManagerByChunk(subjectID, path, cellBoundary, spikeChannels,spikeDetectionParams, spikeSortingParams,...
    timeRangePerTrialSecs,stimClassToAnalyze,overwriteAll,usePhotoDiodeSpikes,[],frameThresholds,paramUtil)

%%
if 0 %oldCalls - a historical chornology
...
% 
% %LGN
% subjectID = '305';cellBoundary={'trialRange',[208 211]} % ffgwn
% subjectID = '305';cellBoundary={'trialRange',[212 217]} % 6X8
% subjectID = '305';cellBoundary={'trialRange',[218 224]} % 6X8
% subjectID = '305';cellBoundary={'trialRange',[225]} % gratings
% subjectID = '305';cellBoundary={'trialRange',[226 235]} % 6X8
% subjectID = '305';cellBoundary={'trialRange',[218 235],'trialMask',[225]} % 6X8
...
subjectID = '305';cellBoundary={'trialRange',[341 377],'trialMask',[342:372 374:376]} % ffgwn
