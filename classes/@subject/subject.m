...
switch nargin
    ...
    case 8
        ...
        if (strcmp(varargin{2},'rat') && strcmp(varargin{3},'long-evans')) || ...
                (strcmp(varargin{2},'squirrel') && strcmp(varargin{3},'wild')) || ...
            ...
            error('species must be rat (strain long-evans), squirrel (strain wild), mouse (strains c57bl/6j dba/2j B6D2F1/J), or degu (strain none)')
        end
