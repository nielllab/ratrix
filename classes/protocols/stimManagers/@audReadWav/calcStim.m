...
if details.startTone
        details.toneFreq = wav1;
    else
        details.toneFreq = wav2;
end

silence = zeros(1, fs1*stimulus.isi/1000);


details.toneFreq = [details.toneFreq silence];

if details.endTone
        details.toneFreq = [details.toneFreq wav1];
    else
        details.toneFreq = [details.toneFreq wav2];
end
