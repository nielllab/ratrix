...
stimulus.duration=(details.numTones)*(stimulus.toneDuration+stimulus.isi)-stimulus.isi;
...
switch stimulus.soundType
    ...
    case {'freeCNMToneTrain'}   
        sSound = soundClip('stimSoundBase','freeCNMToneTrain',[stimulus.freqs(details.startTone) stimulus.freqs(details.endTone) details.numTones stimulus.isi stimulus.toneDuration]) ;
        sSound2 = soundClip('stimSoundBase','tone',[stimulus.freqs(details.endTone)]) ; %to play during earlyPenalty phase
end
...
stimulus.stimSound2 = soundClip('stimSound','dualChannel',{sSound2,details.leftAmplitude},{sSound2,details.rightAmplitude});

%sounds={stimulus.stimSound setName(stimulus.stimSound,'correctSound') setName(stimulus.stimSound,'keepGoingSound')};
sounds={stimulus.stimSound setName(stimulus.stimSound2, 'stimSound2') setName(mycorrectSound,'correctSound') setName(mykeepGoingSound,'keepGoingSound')};
