...
if stimDetails.overrideSoundCues && strcmp(phaseType,'discrim') && strcmp(trialManagerClass,'freeGoNoGo')
...
if stepsInPhase <= 0 && ...
        ((strcmp(phaseType,'discrim') && strcmp(trialManagerClass,'freeGoNoGo')))
...
if stepsInPhase <= 0 && ...
        ((strcmp(phaseType,'earlyPenalty') && strcmp(trialManagerClass,'freeGoNoGo'))) 
    soundsToPlay{2}{end+1} = {'stimSound2' stimManager.toneDuration};    
end
