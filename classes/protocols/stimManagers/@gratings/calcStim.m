...
out.stimSpecs{1} = stimSpec(stim,{[] 2},'expert',1,[],1,targetPorts,[],[],getScaleFactor(stimulus),0); % expert mode

% final phase
out.stimSpecs{2} = stimSpec(interTrialLuminance,{[] 1},'loop',1,[],1,[],1,[],getScaleFactor(stimulus),1);
