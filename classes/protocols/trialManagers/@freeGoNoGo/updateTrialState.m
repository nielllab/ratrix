...
if ~isempty(phaseType) && strcmp(phaseType,'earlyPenalty') && framesInPhase==0
    ...
    %%if there is an early response in goNoGo, classify as incorrect;
     trialRecords(end).trialDetails.correct = 1; %%if there is an early response in goNoGo, classify as incorrect
    correct = 1;
    result = 'nominal';
end


if ~isempty(phaseType) && strcmp(phaseType,'earlyPenalty') && framesInPhase==20
    %      [rm rewardSizeULorMS=0 garbage msPenalty msPuff=0 msRewardSound=0 msPenaltySound updateRM] =...
    %         calcEarlyPenalty(getReinforcementManager(tm),trialRecords, []);
    %%if there is an early response in goNoGo, classify as incorrect;
    if rand > .5
...
if ~isempty(phaseType) && strcmp(phaseType,'earlyPenalty') && framesInPhase==30
    %      [rm rewardSizeULorMS=0 garbage msPenalty msPuff=0 msRewardSound=0 msPenaltySound updateRM] =...
    %         calcEarlyPenalty(getReinforcementManager(tm),trialRecords, []);
    %%if there is an early response in goNoGo, classify as incorrect;
    if rand > .5
...
if ~isempty(phaseType) && strcmp(phaseType,'earlyPenalty') && framesInPhase==40
    %      [rm rewardSizeULorMS=0 garbage msPenalty msPuff=0 msRewardSound=0 msPenaltySound updateRM] =...
    %         calcEarlyPenalty(getReinforcementManager(tm),trialRecords, []);
    %%if there is an early response in goNoGo, classify as incorrect;
    if rand > .5
...
if ~isempty(phaseType) && strcmp(phaseType,'earlyPenalty') && framesInPhase==50
    %      [rm rewardSizeULorMS=0 garbage msPenalty msPuff=0 msRewardSound=0 msPenaltySound updateRM] =...
    %         calcEarlyPenalty(getReinforcementManager(tm),trialRecords, []);
    %%if there is an early response in goNoGo, classify as incorrect;
    if rand > .5
...
if ~isempty(phaseType) && strcmp(phaseType,'itl') && framesInPhase==0
    c = correct;
    if isempty(correct)
        correct = 0;
