...
public class RatrixNetworkCommand implements Serializable
{
//     public static final int PROTOCOL_VERSION = 1;
    ...
    public static final int C_SERVER_RESET_COMMAND = -3;
    public static final int C_KEEP_ALIVE_COMMAND = -4;
    public static final int S_KEEP_ALIVE_ACK_COMMAND = -5;
...
//     public static final int S_SEND_OBJECT_COMMAND = 103;
    public int UID;
    public int command;
    public RatrixNetworkClientIdent client;
    public Date arrived;
    public Object arguments[];
    public int priority;


    public RatrixNetworkCommand(int UID, RatrixNetworkClientIdent client, int priority, int command)
    {
	this(UID,client,priority,command,null);
    }

    public RatrixNetworkCommand(int UID, RatrixNetworkClientIdent client, int priority, int command, Object arguments[])
    {
	this.UID = UID;
	this.client = client;
	...
	{
	    return "RatrixNetworkCommand(UID:" + this.UID + ",\tclient:" + this.client.id + ",\tcomm:" + this.command + ",\tarr:<null>)";
	}
	else
	{
	    return "RatrixNetworkCommand(UID:" + this.UID + ",\tclient:" + this.client.id + ",\tcomm:" + this.command + ",\tarr:" + this.arrived + ")";
	}
    }
