%edf downloaded from
%http://www.mathworks.com/matlabcentral/fileexchange/13845 and renamed to
%sliderPanelHoriz to avoid conflict with ...\ratrix\analysis\eflister\realtimeSpkSorting\dataNet\sliderPanel
%which i earlier hacked to be vertical

function [sliderHandle,panelHandle,editHandle] = sliderPanelHoriz(parent,PanelPVs,SliderPVs,EditPVs,LabelPVs,numFormat,varargin)
