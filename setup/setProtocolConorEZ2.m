function r = setProtocolConorEZ2(r,subjIDs)
...
soundParams.isi = 500;
CNMStimMedium = CNMafc(interTrialLuminance,soundParams,maxWidth,maxHeight,scaleFactor,interTrialLuminance);
...
ts5 = trainingStep(lpTM  , CNMStimMedium, performanceCriterion(.85, int8(200)), noTimeOff(), svnRev,svnCheckMode);
