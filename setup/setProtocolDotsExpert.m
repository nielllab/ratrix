...
textureSize=[maxWidth maxHeight]; %10*[w*5 h];
zoom=fliplr([maxWidth maxHeight]./textureSize);
...
speed_degpersec = 30*10;
size_deg = 10;
density = 0.04;

speed = speed_degpersec*pixperdeg*(1/hz)/zoom(1);
dotSize = size_deg*pixperdeg/zoom(1) 
...
dots=coherentDots(textureSize(1),textureSize(2),numDots,coherence,speed,contrast,dotSize,duration,zoom,maxWidth,maxHeight,'expert',0.5);
