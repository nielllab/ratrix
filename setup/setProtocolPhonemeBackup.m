function r = setProtocolPhonemeBackup(r,subjIDs)
...
p=protocol('mouse phoneme discrimination backup version',{ts1, ts2, ts3, ts4, ts5 ts6 ts7});
...
for i=1:length(subjIDs),
    ...
    [subj r]=setProtocolAndStep(subj,p,true,false,true,stepNum,r,'call to setProtocolPhonemeBackup','edf');
end