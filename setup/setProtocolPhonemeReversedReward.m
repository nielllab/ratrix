function r = setProtocolPhonemeReversedReward(r,subjIDs)
...
soundParams.soundType='phonemeWavReversedReward';
soundParams.freq = [];
...
p=protocol('mouse phoneme discrimination reversed rewards version',{ts1, ts2, ts3, ts4, ts5 ts6 ts7});
...
for i=1:length(subjIDs),
    ...
    [subj r]=setProtocolAndStep(subj,p,true,false,true,stepNum,r,'call to setProtocolPhonemeReversedReward','edf');
end