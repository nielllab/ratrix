function r = setProtocolWMStackWarbleBackup(r,subjIDs)
...
soundParams.soundType='warblestackWav'; %new soundType for CNM stimulus
soundParams.freqs = []; %the two possible frequencies
...
p=protocol('mouse WM task Warble vs Harmonic',{ts1, ts2, ts3, ts4, ts5 ts6}); %to test CNM/goNoGo
...
for i=1:length(subjIDs),
    ...
    [subj r]=setProtocolAndStep(subj,p,true,false,true,stepNum,r,'call to setProtocolWMStackWarbleBackup','edf');
end