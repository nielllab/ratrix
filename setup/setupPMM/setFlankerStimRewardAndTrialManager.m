...
switch tmClass
    case 'nAFC'
        tm=nAFC(p.msFlushDuration,p.msMinimumPokeDuration,p.msMinimumClearDuration,p.sndManager,...
            ...
            p.maintainPokeToMaintainStim,p.msMaximumStimPresentationDuration,p.maximumNumberStimPresentations,...
            p.doMask,increasingReward,p.eyeTracker,p.eyeController,mfilename,p.datanet,...
